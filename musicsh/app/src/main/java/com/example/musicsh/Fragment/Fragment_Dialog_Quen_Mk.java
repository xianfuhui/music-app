...
public class Fragment_Dialog_Quen_Mk extends Fragment {
    ...
    private void senMail(String tkqmk){
        final String email = "huyremoving9031@gmail.com";
        final  String password = "rebryxizqafxiten";
        Random random = new Random();
        code = 10000 + random.nextInt(89999);
        String messenger = "[MusicS-H] Mã xác nhận của bạn là :"+ code +". Không chia sẻ mã này cho bất kì ai.";
