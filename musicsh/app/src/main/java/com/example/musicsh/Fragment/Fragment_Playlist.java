...
import com.example.musicsh.Activity.HomeActivity;
import com.example.musicsh.Adapter.PlaylistAdapter;
import com.example.musicsh.Model.PlaylistModel;
import com.example.musicsh.R;
import com.example.musicsh.Service_API.APIService;
import com.example.musicsh.Service_API.Dataservice;
...
public class Fragment_Playlist extends Fragment implements Dialog_update_user.ExampleDialogListenerUpdateUser{
    ...
    public void apply(String tenUser, Bitmap bitmap) {
        if (bitmap != null){
            ...
            sql = "UPDATE tbNguoiDung SET Ten ='"+tenUser+"', ImageURL =  'https://huy329.000webhostapp.com/HinhAnh/NguoiDung/"+hm.getTaikhoan()+".jpg' WHERE TaiKhoan = '"+hm.getTaikhoan()+"'";
        }else {
